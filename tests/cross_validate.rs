...
fn mul_known_vector_1() {
    ...
    assert_eq!(a.mul_2_33(b), expected);
}
...
fn inv_known_vector_1() {
    ...
    assert_eq!(a.invert_2_48().unwrap(), expected);
}
...
fn inv_known_vector_3() {
    let a = GF2_128::new(0x1, 0);
    assert_eq!(a.invert_2_48().unwrap(), GF2_128::one());
}
...
fn pow_known_vector_3() {
    ...
    assert_eq!(a.pow_rtl_2_34_2_39(3), expected);
}
...
fn pow_known_vector_17() {
    ...
    assert_eq!(a.pow_rtl_2_34_2_39(17), expected);
}
...
fn pow_known_vector_5() {
    ...
    assert_eq!(a.pow_rtl_2_34_2_39(5), expected);
}
...
fn square_known_vector_1() {
    ...
    assert_eq!(a.square_2_39(), expected);
}
